...
var IntlTelInput = (0, import_react.forwardRef)(function IntlTelInput2({
  ...
  const [filteredCountries, setFilteredCountries] = (0, import_react.useState)(data_default);
  ...
  const renderCountryItem = ({ item }) => /* @__PURE__ */ import_react.default.createElement(
    ...
    /* @__PURE__ */ import_react.default.createElement(import_react_native.Text, { style: [styles.flag, flagStyle] }, getCountryFlag(item.iso2)),
  ...
  return /* @__PURE__ */ import_react.default.createElement(import_react_native.View, { style: [styles.container, style] }, /* @__PURE__ */ import_react.default.createElement(import_react_native.View, { style: styles.inputContainer }, initOptions.allowDropdown !== false && /* @__PURE__ */ import_react.default.createElement(
    import_react_native.TouchableOpacity,
    {
    ...
    initOptions.showFlags !== false && /* @__PURE__ */ import_react.default.createElement(import_react_native.Text, { style: [styles.selectedFlag, flagStyle] }, getCountryFlag(selectedCountry?.iso2 || "")),
    initOptions.separateDialCode && /* @__PURE__ */ import_react.default.createElement(import_react_native.Text, { style: [styles.selectedDialCode, textStyle] }, "+", selectedCountry?.dialCode),
    ...
    /* @__PURE__ */ import_react.default.createElement(import_react_native.View, { style: styles.modalContainer }, /* @__PURE__ */ import_react.default.createElement(import_react_native.View, { style: styles.modalHeader }, /* @__PURE__ */ import_react.default.createElement(
      import_react_native.TouchableOpacity,
      {
    ...
    ), /* @__PURE__ */ import_react.default.createElement(import_react_native.Text, { style: styles.modalTitle }, "Select Country")), initOptions.countrySearch !== false && /* @__PURE__ */ import_react.default.createElement(
      import_react_native.TextInput,
      {
